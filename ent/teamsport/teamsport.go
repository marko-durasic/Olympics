...
const (
	// Label holds the string label denoting the teamsport type in the database.
	Label = "team_sport"
	...
	// Table holds the table name of the teamsport in the database.
	Table = "team_sports"
)

// Columns holds all SQL columns for teamsport fields.
var Columns = []string{
	FieldID,
	FieldCountry,
	FieldSport,
...
// OrderOption defines the ordering options for the TeamSport queries.
